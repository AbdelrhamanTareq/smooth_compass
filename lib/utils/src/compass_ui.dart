...
class SmoothCompass extends StatefulWidget {
  ...
  //////////////////////////////////
  final String? compassSupportText;
  final String? enableLocationText;
  final String? locationServicesDisabledText;
  final String? allowLocationText;
  final String? allowPermissionText;
  final String? openSettingsText;
  final String? locationServicesPermentDeniedText;
  final String? allowLocationFromSettingsAndPrivacyText;
  ...
  const SmoothCompass({
    ...
    ///////////////////////
    this.compassSupportText,
    this.enableLocationText,
    this.locationServicesDisabledText,
    this.allowLocationText,
    this.allowPermissionText,
    this.openSettingsText,
    this.locationServicesPermentDeniedText,
    this.allowLocationFromSettingsAndPrivacyText,
  }) : super(key: key);
          ...
          if (!snapshot.data!) {
            return Center(
                child: FittedBox(
                    ...
                    child: Text(widget.compassSupportText ??
                    ...
                    if (serviceSnapshot.connectionState ==
                      ...
                      return CustomErrorWidget(
                        title: widget.errorDecoration?.buttonText
                                ?.onLocationDisabled ??
                            (widget.enableLocationText ?? "Enable Location"),
                        buttonTextStyle:
                        ...
                        errMsg: widget.locationServicesDisabledText ??
                            ...
                            return Platform.isAndroid
                                ? CustomErrorWidget(
                                    ...
                                    errMsg: widget
                                            ...
                                            ?.permissionMessage
                                            ?.permanentlyDenied ??
                                        (widget.locationServicesPermentDeniedText ??
